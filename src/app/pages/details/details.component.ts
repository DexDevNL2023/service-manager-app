...
export class DetailsComponent implements OnInit {
    ...
    constructor(private location: Location, private route: ActivatedRoute, private router: Router, private sharedService: SharedService, private detailsApiService: DetailsApiService, private generalUtilsService: GeneralUtilsService) { }
